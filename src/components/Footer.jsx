                    ...
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
                                <img className="w-12 h-12 rounded-full" src="https://i.ibb.co/pvZ7kZh/pexels-pixabay-257700.jpg" alt="" />
                            </div>
                            <span className="self-center text-2xl font-semibold">TechForge Industries</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <a rel="noopener noreferrer" href="#">Textile Factory</a>
                                </li>
                                <li>
